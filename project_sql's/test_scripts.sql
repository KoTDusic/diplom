...
execute SET_PROGRESS('1-1101','Системное программирование','Преподаватель2','Студент6','Делегирование','Сдано');
execute SET_PROGRESS('1-1101','Системное программирование','Преподаватель2','Студент2','Делегирование','Сдано');
execute SET_PROGRESS('1-1102','Схемотехника','Преподаватель3','Студент7','ShemBuilder','Сдано');
 
execute ADD_LAB('сохранение картинок','сохранять карттинки');
execute SET_PROGRESS('1-1101','Системное программирование','Преподаватель2','Студент2','Агрегирование','Сдано');
