...
select "Название_факультета" as "Факультет", "Группы"."Код_группы", "Имя_специальности" as "Специальность","Группы"."Код_специальности", 
"Группы"."Год_поступления",GET_KOORS_BY_YEAR("Группы"."Год_поступления") as "Курс","Номер_группы","Номер_подгруппы",count("Код_студента") as "Студентов"
from "Группы" 
...
right join "Студенты" on "Студенты"."Код_подгруппы"="Подгруппы"."Код_подгруппы"
