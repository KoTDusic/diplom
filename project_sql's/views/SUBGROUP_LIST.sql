...
select "Название_факультета" as "Факультет", "Группы"."Код_группы","Подгруппы"."Код_подгруппы",
"Имя_специальности" as "Специальность","Группы"."Код_специальности", "Специальность"."Номер_специальности",
