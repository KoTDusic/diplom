create or replace view STUDENT_LAB_DISCIPLINE as 
select "Студенты"."ФИО","Группы"."Код_специальности","Студенты"."Код_студента","Подгруппы"."Код_подгруппы",
GET_KOORS_BY_YEAR("Группы"."Год_поступления") as "Курс","Группы"."Номер_группы","Номер_подгруппы","Дисциплина"."Наименование_дисциплины",
...
left join "Дисциплина" on "Дисциплина"."Код_дисциплины"="Успеваемость"."Код_дисциплины"
group by("Студенты"."ФИО","Группы"."Код_специальности","Студенты"."Код_студента","Подгруппы"."Код_подгруппы",
GET_KOORS_BY_YEAR("Группы"."Год_поступления"),"Группы"."Номер_группы","Номер_подгруппы","Дисциплина"."Наименование_дисциплины");